...
tags: ["backend", "microservices", "message queue"]
---
...
- Receive Messages:
    ...
    - The broker accepts and acknowledges them.
- Store Messages:
    - Messages may be stored:
        - In memory
        - On Disk
        - Or both
    - This prevents message lose when consumers are slow or offline.
- Route Messages:
    - The broker decides where messages go, based on:
        - Topics
        - Routing keys
        - Queues
        - Partitions
